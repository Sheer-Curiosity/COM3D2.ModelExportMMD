    ...
    public class PmxBuilder : IExporter
    {
        ...
        public void ChangeMorphName()
        {
            if (FindBone("Bone_Face") != null)
            {
                ...
                pmxMorph.Name = "あa";
                pmxMorph.Panel = 3;
                Console.WriteLine("Translated moutha");
                pmxMorph = FindMorph("mouthc");
                pmxMorph.Name = "うu";
                pmxMorph.Panel = 3;
                Console.WriteLine("Translated mouthc");
                pmxMorph = FindMorph("mouthi");
                pmxMorph.Name = "いi";
                pmxMorph.Panel = 3;
                Console.WriteLine("Translated mouthi");
                pmxMorph = FindMorph("mouths");
                pmxMorph.Name = "ワ";
                pmxMorph.Panel = 3;
                Console.WriteLine("Translated mouths");
                pmxMorph = FindMorph("mouthup");
                pmxMorph.Name = "にやり";
                pmxMorph.Panel = 3;
                Console.WriteLine("Translated mouthup");
                pmxMorph = FindMorph("eyeclose");
                pmxMorph.Name = "まばたき";
                pmxMorph.Panel = 2;
                Console.WriteLine("Translated eyeclose");
                pmxMorph = FindMorph("eyeclose2");
                pmxMorph.Name = "笑い";
                pmxMorph.Panel = 2;
                Console.WriteLine("Translated eyeclose2");
                pmxMorph = FindMorph("eyeclose5");
                pmxMorph.Name = "ウィンク";
                pmxMorph.Panel = 2;
                Console.WriteLine("Translated eyeclose5");
                pmxMorph = FindMorph("eyeclose6");
                pmxMorph.Name = "ウィンク2";
                pmxMorph.Panel = 2;
                Console.WriteLine("Translated eyeclose6");
                pmxMorph = FindMorph("eyebig");
                pmxMorph.Name = "びっくり";
                pmxMorph.Panel = 2;
                Console.WriteLine("Translated eyebig");
                pmxMorph = FindMorph("eyeclose3");
                pmxMorph.Name = "ジト目";
                pmxMorph.Panel = 2;
                Console.WriteLine("Translated eyeclose3");
                pmxMorph = FindMorph("mayuha");
                pmxMorph.Name = "困る";
                pmxMorph.Panel = 1;
                Console.WriteLine("Translated mayuha");
                pmxMorph = FindMorph("mayuup");
                pmxMorph.Name = "にこり";
                pmxMorph.Panel = 1;
                Console.WriteLine("Translated mayuup");
                pmxMorph = FindMorph("mayuw");
                pmxMorph.Name = "怒り";
                pmxMorph.Panel = 1;
                Console.WriteLine("Translated mayuw");
                pmxMorph = FindMorph("mayuv");
                pmxMorph.Name = "真面目";
                pmxMorph.Panel = 1;
                Console.WriteLine("Translated mayuv");
                pmxMorph = FindMorph("hohos");
                pmxMorph.Name = "照れ";
                pmxMorph.Panel = 4;
                Console.WriteLine("Translated hohos");
                pmxMorph = FindMorph("hoho");
                pmxMorph.Name = "照れ2";
                pmxMorph.Panel = 4;
                Console.WriteLine("Translated hoho");
                pmxMorph = FindMorph("namida");
                pmxMorph.Name = "涙";
                pmxMorph.Panel = 4;
                Console.WriteLine("Translated namida");
            }
        }
        ...
        public void AddMorph()
        {
            ...
            pmxGroupMorph.Index = FindMorphIndex("moutha");
            ...
            pmxGroupMorph.Index = FindMorphIndex("mouthi");
            ...
            pmxMorph.Panel = 3;
            pmxGroupMorph = new PmxGroupMorph();
            pmxGroupMorph.Index = FindMorphIndex("mouthc");
            pmxGroupMorph.Ratio = 0.6f;
            pmxMorph.OffsetList.Add(pmxGroupMorph);
            pmxGroupMorph = new PmxGroupMorph();
            pmxGroupMorph.Index = FindMorphIndex("moutha");
